...
| Harness parity concepts | `docs/reference/internal/harnesses-explained.md` | `docs/reference/internal/harness-anatomy.md` | Teaching doc owns the why (incl. the Claude-vs-Codex matrix, folded in from the former `cross-harness-behavior-assessment.md`). Anatomy owns exact commands. Per-element persistence lives in `config-collision-handling.md`. |
...
| Rules generation/layering | `docs/reference/internal/rules-parity-and-layering.md` | `docs/reference/internal/config-collision-handling.md` | Needs one explicit paragraph on managed-block injection preserving user text outside the block. |
...
| Understand Claude/Codex parity | `docs/reference/internal/harnesses-explained.md` | `docs/reference/internal/harness-anatomy.md` |
