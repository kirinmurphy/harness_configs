...
- Localhost already groups running instances by canonical repository and remains the operational runtime page.
...
| Activity | Active/inactive/unknown from repository/runtime data |
